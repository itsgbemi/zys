  ...
  const renderBackHeader = (title: string) => (
    <div className="flex items-center justify-between mb-8">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#1918f0]/5 border border-[#1918f0]/10">
         {isSaving ? (
           <><Loader2 size={12} className="animate-spin text-[#1918f0]" /><span className="text-[10px] font-bold text-[#1918f0] uppercase tracking-widest">Autosaving...</span></>
         ) : (
           <><Check size={12} className="text-emerald-500" /><span className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest">Saved to Cloud</span></>
         )}
      </div>
    </div>
  );
